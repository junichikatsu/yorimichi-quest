import type { AreaId, Spot, SpotCategory, SpotId } from '@yorimichi-sample/shared'
import { asAreaId, asSpotId } from '@yorimichi-sample/shared'
...
/**
 * チェックイン数を事前計算して保持する（データストアに集計機能が無いため）。
 * 読み取り時に数えられないので、書き込み時に更新する。
 */
